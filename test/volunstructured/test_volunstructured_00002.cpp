...
* Subtest 001
*
* Testing dump/restore of a 2D unstructured patch.
*
...
*/
int subtest_001(VolUnstructured *patch_2D, VolUnstructured *patch_2D_restored)
{
    ...
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 3,  7, 15}}));
    patch_2D->addCell(ElementType::QUAD,     true, std::vector<long>({{ 1, 11, 16, 10}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 8,  9, 18}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 8, 18, 14}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 3, 15,  5}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 9, 10, 18}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{10, 16, 18}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 4, 17, 12}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 4,  5, 17}}));
    patch_2D->addCell(ElementType::QUAD,     true, std::vector<long>({{13, 17, 15, 14}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{11, 12, 19}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{13, 19, 17}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{12, 17, 19}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{13, 14, 18}}));
    patch_2D->addCell(ElementType::TRIANGLE, true, std::vector<long>({{ 5, 15, 17}}));
    ...
    OBinaryArchive binaryWriter2D("unstructured_patch_2D", archiveVersion, header2D);
...
* Subtest 002
*
* Testing dump/restore of a 3D unstructured patch.
*
...
*/
int subtest_002(VolUnstructured *patch_3D, VolUnstructured *patch_3D_restored)
{
    int archiveVersion = 1;
    ...
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 21, 28, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 4, 26, 23, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{24, 29, 25, 23}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{29, 21, 22, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 28, 27, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{23, 26, 29, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 23, 29, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 26, 29, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{24, 29, 23, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 21, 29, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{29, 25, 23, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 4, 23,  3, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{31, 18, 27, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{22, 12, 25, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 26, 11, 27}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 9, 19, 24, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 21, 14, 28}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{15, 22,  7, 25}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{15, 29, 22, 25}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{25, 12, 23, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{23,  4,  3,  2}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26, 18, 11, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 9, 24, 23, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{21, 26, 14, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{28, 21, 13, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{30, 18, 19, 10}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{30, 31, 29, 18}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{30, 31, 18, 10}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{21,  8, 28, 13}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{16, 13, 29, 28}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{16, 13, 28,  8}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{13, 15, 22,  7}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{13, 15, 29, 22}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{15, 24, 29, 25}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{21, 13, 29, 22}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{28, 16, 27, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{31, 18,  5, 27}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{24, 30, 15, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{16, 31, 27, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 11,  5, 27}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{30, 19, 24,  6}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 1, 26, 11, 17}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{19,  9, 24,  6}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{14, 21,  8, 28}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 31,  5, 10}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{23, 12,  3, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{19, 30, 10,  6}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 7, 22, 12, 25}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{24, 30,  6, 15}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{16, 31,  5, 27}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{23,  9, 17,  2}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{26,  4, 14, 20}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 17, 24, 19}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{24, 17, 18, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{18, 24, 30, 19}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{30, 24, 18, 29}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 2, 17, 26,  1}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 2, 26, 17, 23}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 4,  2, 26,  1}}));
    patch_3D->addCell(ElementType::TETRA,      true, std::vector<long>({{ 4, 26,  2, 23}}));
    patch_3D->addCell(ElementType::WEDGE,      true, std::vector<long>({{ 2, 4, 1, 33, 35, 32}}));
    patch_3D->addCell(ElementType::WEDGE,      true, std::vector<long>({{ 4, 2, 3, 35, 33, 34}}));
    patch_3D->addCell(ElementType::PYRAMID,    true, std::vector<long>({{36, 37, 38, 39, 33}}));
    patch_3D->addCell(ElementType::PYRAMID,    true, std::vector<long>({{39, 38, 34, 35, 33}}));
    ...
    OBinaryArchive binaryWriter3D("unstructured_patch_3D", archiveVersion, header3D);
...
int subtest_003()
{
    ...
    OBinaryArchive binaryWriterPM("unstructured_patch_PM", archiveVersion, headerPM);
    ...
    IBinaryArchive binaryReaderPM("unstructured_patch_PM");
