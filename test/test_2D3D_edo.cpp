...
int main(int argc, char *argv[]) {
	...
	/*				if((pow((center[0]-C4[0]),2.0)+pow((center[1]-C4[1]),2.0)+pow((center[2]-C4[2]),2.0) <= pow(R4+oct.getSize(),2.0))){
	//						&& (pow((center[0]-C4[0]),2.0)+pow((center[1]-C4[1]),2.0)+pow((center[2]-C4[2]),2.0) >= pow(R4-oct.getSize(),2.0)) ){
						ptree.octree.setMarker(i,1);
					}
					if((pow((center[0]-C5[0]),2.0)+pow((center[1]-C5[1]),2.0)+pow((center[2]-C5[2]),2.0) <= pow(R5+oct.getSize(),2.0))){
	//						&& (pow((center[0]-C5[0]),2.0)+pow((center[1]-C5[1]),2.0)+pow((center[2]-C5[2]),2.0) >= pow(R5-oct.getSize(),2.0)) ){
						ptree.octree.setMarker(i,1);
					}*/
