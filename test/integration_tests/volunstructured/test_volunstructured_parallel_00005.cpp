...
* Subtest 001
*
* Testing multi-layer ghost halo on unstructured patches (the test is meant to
* be run on 2 processes).
*/
int subtest_001()
{
    ...
    log::cout() << "Testing multi-layer ghost halo on unstructured patches" << std::endl;
