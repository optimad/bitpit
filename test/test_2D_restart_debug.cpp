...
int main(int argc, char *argv[]) {
	...
	{
		int rank, nproc, error_flag;
		double X, Y, Z, L;
		uint8_t level0;
		vector<int> levels;
		//vector<vector<int> > XY(10, vector<int> (2,0));
		...
		Class_Para_Tree<2> ptree(X, Y, Z, L, XY, levels);
