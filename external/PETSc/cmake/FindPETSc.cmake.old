...
")
 ...
 See http://www.cmake.org/Wiki/CMake_FAQ#How_can_I_build_my_MSVC_application_with_a_static_runtime.3F")
  ...
  if (PETSC_LIBRARY_VEC)
    ...
    # If the library has not been found, we may be on Debian > 9 or
    # Ubuntu > 16.04. Those distributions use _real and _complex suffixes.
...
")
  ...
  get_property(CMAKE_INCLUDE_DIRECTORIES DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} PROPERTY INCLUDE_DIRECTORIES)
  set (petsc_includes_minimal ${PETSC_INCLUDE_CONF} ${PETSC_INCLUDE_DIR} ${CMAKE_INCLUDE_DIRECTORIES})
