 ...
 * @return distance
 */
double CGElem::distancePointLine(
 ...
 * @return distance
 */
double CGElem::distancePointPlane(
        std::array< double, 3 > const &P,
        std::array< double, 3 > const &Q,
        std::array< double, 3 > const &n,
        std::array< double, 3 > &xP
 ...
 * @return distance
 */
double CGElem::distancePointSegment(
        std::array< double, 3 > const &P,
 ...
 * @return distance
 */
double CGElem::distancePointTriangle(
        std::array< double, 3 > const &P,
        std::array< double, 3 > const &Q1,
        std::array< double, 3 > const &Q2,
    ...
    if( count == 0){
        ...
        if( count == 1){
            ...
            vertex1 = (vertex0     +1) %3 ;
            d       =  CGElem::distancePointSegment(P,r[vertex0],r[vertex1],xP, flagLocal)  ;
 ...
 * @return distance
 */
std::vector<double> CGElem::distanceCloudTriangle(
    ...
    for( k=0; k<N; ++k) {
        ...
        if( count == 0){
            ...
            if( count == 1){
                ...
                d[k]       =  CGElem::distancePointSegment( P[k],r[vertex0],r[vertex1],xP[k], flagLocal)  ;
 ...
 * @return distance
 */
double CGElem::distancePointSimplex(
        std::array< double, 3 >            const &P,
 ...
 * @return distance
 */
std::vector<double> CGElem::distanceCloudSimplex(
        std::vector< std::array< double, 3 > >  const &P,
        std::vector< std::array< double, 3 > >  const &V,
        std::vector< std::array< double, 3 > >        &xP,
        std::vector< int >                       &flag
 ...
 * @return if intersect
 */
bool CGElem::intersectSegmentSegment(
        std::array<double, 3> const &P1,
        std::array<double, 3> const &P2,
        std::array<double, 3> const &Q1,
        std::array<double, 3> const &Q2,
 ...
 * @return if intersect
 */
bool CGElem::intersectLinePlane(
        std::array<double, 3> const &P1,
        std::array<double, 3> const &n1,
        std::array<double, 3> const &P2,
        std::array<double, 3> const &n2,
 ...
 * @return if intersect
 */
bool CGElem::intersectSegmentPlane(
        std::array<double, 3> const &Q1,
        std::array<double, 3> const &Q2,
        std::array<double, 3> const &P2,
        std::array<double, 3> const &n2,
 ...
 * @return if intersect
 */
bool CGElem::intersectPlanePlane(
        std::array<double, 3> const &P1,
        std::array<double, 3> const &n1,
        std::array<double, 3> const &P2,
        std::array<double, 3> const &n2,
 ...
 * @return if intersect
 */
bool CGElem::intersectLineTriangle(
        std::array<double, 3> const &P,
        std::array<double, 3> const &n,
 ...
 * @return if intersect
 */
bool CGElem::intersectSegmentTriangle(
 ...
 * @return if intersect
 */
bool CGElem::intersectLineSimplex(
        std::array<double, 3> const          &P,
        std::array<double, 3> const          &n,
        std::vector<std::array<double, 3> > const &V,
        std::array<double, 3>                &Q
 ...
 * @return if intersect
 */
bool CGElem::intersectSegmentSimplex(
        std::array<double, 3> const          &P0,
        std::array<double, 3> const          &P1,
        std::vector<std::array<double, 3> > const &V,
        std::array<double, 3>                &Q 
 ...
 * @return if intersect
 */
bool CGElem::intersectBoxTriangle(
        std::array<double, 3> const              &A1, 
        std::array<double, 3> const              &A2,
    ...
    CGElem::computeAABBTriangle( V1, V2, V3, B1, B2) ;

    if( !CGElem::intersectBoxBox( A1, A2, B1, B2) ) { return(false); }

    //Check if Triangle Box edges intersection 
    for( int i=0; i<12; ++i){
        CGElem::EdgeOfBox( i, A1, A2, E1, E2) ;
        if( CGElem::intersectSegmentTriangle(E1,E2,V1,V2,V3,P)) { return(true); }
    };
...
bool CGElem::intersectBoxTriangle(
    ...
    for( int i=0; i<12; ++i){
        CGElem::EdgeOfBox( i, A1, A2, E1, E2) ;
        if( CGElem::intersectSegmentTriangle(E1,E2,V1,V2,V3,p)) { 
            P.push_back( p );
            intersect = true ;
        } ;
    };
 ...
 * @return if intersect
 */
bool CGElem::intersectSegmentBox(
        std::array<double, 3> const              &V1,
        std::array<double, 3> const              &V2,
        std::array<double, 3> const              &A1,
        std::array<double, 3> const              &A2,
    ...
    //Check if Triangle Boundig Box and Box overlap -> necessary condition
    CGElem::computeAABBSegment( V1, V2, B1, B2) ;
    if( !CGElem::intersectBoxBox( A1, A2, B1, B2, dim) ) { return(false); }
    ...
    if( dim == 2){
        ...
        for( i=0; i<4; ++i){
            ...
            if( CGElem::intersectSegmentSegment(E1,E2,V1,V2,p)) { return(true); } ;
    ...
    { //3D
        ...
        for( i=0; i<12; ++i){
            CGElem::FaceOfBox( i, A1, A2, E[0], E[1], E[2], E[3]) ;

            if( CGElem::intersectSegmentSimplex(V1,V2,E,p) ) { return(true); } ;
...
bool CGElem::intersectSegmentBox(
    ...
    if( dim == 2){ //check if box edge and segment intersect
        ...
        for( i=0; i<4; ++i){
            ...
            if( CGElem::intersectSegmentSegment(E1,E2,V1,V2,p)) { 
                intersect = true ;
                P.push_back(p) ;
            } ;
        ...
        for( i=0; i<12; ++i){
            ...
            if( CGElem::intersectSegmentSimplex(V1,V2,E,p) ) { 
                intersect = true ;
                P.push_back(p) ;
            } ;
 ...
 * @return if intersect
 */
bool CGElem::intersectBoxSimplex(
        std::array<double, 3> const              &A1,
        std::array<double, 3> const              &A2,
    ...
    //Check if Triangle Boundig Box and Box overlap -> necessary condition
    CGElem::computeAABBSimplex( VS, B1, B2) ;
    ...
    if( n == 2){
        return( CGElem::intersectSegmentBox( VS[0], VS[1], A1, A2, dim ) ) ;
    }

    else if( n == 3){
        return(  CGElem::intersectBoxTriangle( A1, A2, VS[0], VS[1], VS[2] ) ) ;
    }
        ...
        while (m < p) {
            ...
            if( CGElem::intersectBoxTriangle( A1, A2, VS[0], VS[i], VS[j] ) ){
                return (true);
            };
...
bool CGElem::intersectBoxSimplex(
    ...
    n = VS.size() ;
    if( n == 2){ //segment
        return( CGElem::intersectSegmentBox( VS[0], VS[1], A1, A2, P, dim ) ) ;
    }

    else if( n == 3){ //triangle
        return(  CGElem::intersectBoxTriangle( VS[0], VS[1], VS[2], A1, A2, P ) ) ;
    }
        ...
        while (m < p) {
            ...
            if( CGElem::intersectBoxTriangle( A1, A2, VS[0], VS[i], VS[j], partial ) ){
                intersect = true ;
...
//to levelset // -------------------------------------------------------------------------- //
//to levelset bool CGElem::intersectLineSurface(
 ...
 */
bool CGElem::intersectPointSegment(
        std::array< double, 3> const &P,
        std::array< double, 3> const &P1,
        std::array< double, 3> const &P2
        ) {
 ...
 * @return if point lies on segment
 */
bool CGElem::intersectPointTriangle(
        std::array<double, 3> const  &P,
        std::array<double, 3> const  &A,
        std::array<double, 3> const  &B,
        std::array<double, 3> const  &C
 ...
 */
void CGElem::computeAABBSegment(
        std::array<double, 3> const &A,
        std::array<double, 3> const &B,
 ...
 * @param[out] P1 max point of bounding box
 */
void CGElem::computeAABBTriangle(
        std::array<double, 3> const &A,
        std::array<double, 3> const &B,
        std::array<double, 3> const &C,
        std::array<double, 3>       &P0,
 ...
 * @param[out] P1 max point of bounding box
 */
void CGElem::computeAABBSimplex(
        std::vector< std::array<double, 3> > const &VS,
        std::array<double, 3>       &P0,
        std::array<double, 3>       &P1
        ) {
...
void CGElem::FaceOfBox(
    ...
    v0 = CGElem::BoxFaceVertexConnectivity[i][0] ;
    v1 = CGElem::BoxFaceVertexConnectivity[i][1] ;
    v2 = CGElem::BoxFaceVertexConnectivity[i][2] ;
    v3 = CGElem::BoxFaceVertexConnectivity[i][3] ;

    CGElem::VertexOfBox(v0, A0, A1, P0 ) ;
    CGElem::VertexOfBox(v1, A0, A1, P1 ) ;
    CGElem::VertexOfBox(v2, A0, A1, P2 ) ;
    CGElem::VertexOfBox(v3, A0, A1, P3 ) ;
...
void CGElem::EdgeOfBox(
    ...
    v0 = CGElem::BoxEdgeVertexConnectivity[i][0] ;
    v1 = CGElem::BoxEdgeVertexConnectivity[i][1] ;
