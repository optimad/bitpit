...
/*!
 * \interface ElementCacheCollection
 * \ingroup levelset
 *
 * \brief The class ElementCacheCollection allows to store a collection of caches for the
 * elements of a mesh.
 */
 ...
 * Constructor.
 *
 * \param kernel is the kernel that will be used by the pierced caches
 */
ElementCacheCollection::ElementCacheCollection(const PiercedKernel<key_type> *kernel)
    : m_kernel(kernel)
{
}
