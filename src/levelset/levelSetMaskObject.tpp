...
# ifndef __BITPIT_LEVELSET_MASK_OBJECT_TPP__
# define __BITPIT_LEVELSET_MASK_OBJECT_TPP__
...
LevelSetMaskObject<storage_manager_t>::LevelSetMaskObject(int id, const std::unordered_set<long> &mask, const VolumeKernel &mesh ) :LevelSetSegmentationObject<storage_manager_t>(id) {
 ...
 */
template<typename storage_manager_t>
LevelSetMaskObject<storage_manager_t>::LevelSetMaskObject(int id, const std::vector<long> &list, long interfaceId, bool invert, const VolumeKernel &mesh ) :LevelSetSegmentationObject<storage_manager_t>(id) {
...
*/
template<typename storage_manager_t>
std::unique_ptr<SurfUnstructured> LevelSetMaskObject<storage_manager_t>::extractCellEnvelope(const std::unordered_set<long> &mask, const VolumeKernel &mesh, std::unordered_map<long,long> &meshToEnvelope){
...
*/
template<typename storage_manager_t>
std::unique_ptr<SurfUnstructured> LevelSetMaskObject<storage_manager_t>::extractFaceEnvelope(const std::vector<long> &list, const VolumeKernel &mesh, std::unordered_map<long,long> &meshToEnvelope){
...
*/
template<typename storage_manager_t>
bool LevelSetMaskObject<storage_manager_t>::sameInterfaceEnvelopeOrientation(const VolumeKernel &mesh, long faceIndex, SurfUnstructured &envelope, long enveIndex){
