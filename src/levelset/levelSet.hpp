...
public:
    ...
    int                     addObject( SurfaceKernel *, double, LevelSetSurfaceSmooting, int id = levelSetDefaults::OBJECT ) ;
    ...
    int                     addObject( SurfUnstructured *, double, LevelSetSurfaceSmooting, int id = levelSetDefaults::OBJECT ) ;
