...
class LevelSetCachedKernel : public LevelSetKernel {
    ...
    public:
    typedef long CellCacheKey;
    typedef LevelSetCache<CellCacheKey> CellCache;
    typedef LevelSetCacheCollection<CellCacheKey> CellCacheCollection;

    template<typename value_t>
    using CellValueCache = LevelSetValueCache<CellCacheKey, value_t>;
