...
/*!
	...
	Tracking will only list changes that involve data collection on the internal
	data structures (e.g., adaption preparation will not track adaption of ghost
	cells).
...
/*!
	...
	on ghost data structures (e.g., ghost cells adaption is not tracked, only
