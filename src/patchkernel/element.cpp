...
*/
ElementHalfEdge::ElementHalfEdge(Element &element, int edge, Winding winding)
    : m_element(element), m_edge(edge),
      m_connect(element.getEdgeConnect(m_edge)),
      m_winding(winding)
{
...
*/
Element & ElementHalfEdge::getElement() const
{
    return m_element;
}
...
*/
int ElementHalfEdge::getEdge() const
{
    return m_edge;
}
...
*/
const ConstProxyVector<long> & ElementHalfEdge::getConnect() const
{
    return m_connect;
}
...
*/
ElementHalfEdge::Winding ElementHalfEdge::getWinding() const
{
	return m_winding;
}
...
*/
void ElementHalfEdge::setWinding(Winding winding)
{
	m_winding = winding;
}

/*!
	Comparison operator for the ElementHalfEdge class.

	\param other is the object to be compared with
	\result Returns true if the two half-edges define the same half-edge,
	false otherwise.
*/
bool ElementHalfEdge::operator==(const bitpit::ElementHalfEdge &other) const
{
...
/*!
	...
	\param other is the object to be compared with
	\result Returns true if the two half-edges define different half-edge,
	false otherwise.
*/
bool ElementHalfEdge::operator!=(const bitpit::ElementHalfEdge &other) const
{
...
/*!
	\class ElementHalfEdge::Hasher
	\ingroup patchelements

	\brief The ElementHalfEdge::Hasher class allows to create hashes for the
	edge items.
*/

/*!
	Generete the hash for the specified edge item.

	\param item is the edge item
	\result The hash of the specified edge item.
*/
std::size_t ElementHalfEdge::Hasher::operator()(const ElementHalfEdge &item) const
{
	...
	if (item.m_winding == ElementHalfEdge::WINDING_NATURAL) {
