...
bool intersectPlanePixel(array3D const &Pp, array3D const &nP, std::array<double, 2> const &A0, std::array<double, 2> const &A1, int dir, double coor, std::array<array3D, 2> &intersection,
...
bool intersectPlanePixel(array3D const &Pp, array3D const &nP, std::array<double, 2> const &A0,
                         std::array<double, 2> const &A1, int dir, double coor, std::array<array3D, 2> &intersection, const double distanceTolerance = DEFAULT_COPLANARITY_TOLERANCE);
bool intersectPlanePixel(array3D const &Pp, array3D const &nP, std::array<double, 2> const &A0, std::array<double, 2> const &A1, int dir, double coor,
...
bool triangulatePolygon(std::size_t nV, array3D const *V, array3D &C, int &subTrianglesCount, std::vector<int> &subTrianglesConn);
bool intersectPlaneTriPolygon(array3D const &P, array3D const &nP, bool update, std::size_t nV, array3D const *V, array3D const &C,
                              int &subTrianglesCount, const std::vector<int> &subTrianglesConn,
                              std::vector<std::array<array3D, 2>> &Qs, std::vector<std::array<int, 2>> &edges_of_Qs, const double distanceTolerance = DEFAULT_DISTANCE_TOLERANCE);
