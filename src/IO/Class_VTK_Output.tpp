...
void VTK::Write_Data_Header( std::fstream &str, bool parallel, UserDataInterface<UserData > myData  ){
...
// =================================================================================== //
template <class UserData>
void  VTK::Write_DataArray( std::fstream &str, VTK::Field_C &field_, UserDataInterface<UserData > myData ){
...
// =================================================================================== //
void  VTK::Write_PDataArray( std::fstream &str, VTK::Field_C &field_ ){
...
void VTK::Write_All_Appended( std::fstream &str, output_C myOutput ){
