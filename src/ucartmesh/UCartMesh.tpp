...
// -------------------------------------------------------------------------- //
template < class T >
unordered_map<int,T> UCartMesh::CellSubSet(
        iarray3E            i0,
        iarray3E            i1,
        const vector<T>     &data
        ) {
    ...
    for( k=i0[2]; k<=i0[2]; ++k){
        for( j=i0[1]; j<=i0[1]; ++j){
            for( i=i0[0]; i<=i0[0]; ++i){
                ...
                I = CellLinearId( i, j, k) ;
                map.emplace_hint( map.end(), I, data[I] ) ;
...
unordered_map<int,T> UCartMesh::CellSubSet(
    ...
    return PointSubSet( CellCartesianId(I0), CellCartesianId(I1), data); 
...
// -------------------------------------------------------------------------- //
template < class T >
unordered_map<int,T> UCartMesh::PointSubSet(
        iarray3E            i0,
        iarray3E            i1,
        const vector<T>     &data
        ) {
...
unordered_map<int,T> UCartMesh::PointSubSet(
    ...
    return PointSubSet( PointCartesianId(I0), PointCartesianId(I1), data); 
