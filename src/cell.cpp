...
*/
void Cell::initialize_interfaces(std::vector<std::vector<Interface *>> &interfaces)
{
	m_interfaces.reset();
	m_interfaces = std::unique_ptr<CollapsedArrayArray<Interface *> >(new CollapsedArrayArray<Interface *>(interfaces));
}
...
{
	m_interfaces = std::unique_ptr<CollapsedArrayArray<Interface *> >(new CollapsedArrayArray<Interface *>(get_face_count(), nInterfaces));
}
...
*/
void Cell::set_interface(const int &face, const int &index, Interface *interface)
{
...
/*!
	...
	\param interface A pointer to the interface
*/
void Cell::set_interfaces(const int &face, Interface **interfaces)
{
...
*/
Interface * Cell::get_interface(const int &face, const int &index) const
{
...
*/
Interface ** Cell::get_interfaces(const int &face) const
{
