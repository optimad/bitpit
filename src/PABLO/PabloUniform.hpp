...
#else
	PabloUniform(uint8_t dim = 2, int8_t maxlevel = 20,std::string logfile = "bitpit");
	PabloUniform(double X, double Y, double Z, double L, uint8_t dim = 2, int8_t maxlevel = 20, std::string logfile = "bitpit");
#endif
