...
namespace bitpit {
    ...
    public:
        ...
        PabloUniform(uint8_t dim = 2, int8_t maxlevel = 20, std::string logfile = "PABLO", MPI_Comm comm = MPI_COMM_WORLD);
...
#else
        PabloUniform(uint8_t dim = 2, int8_t maxlevel = 20,std::string logfile = "PABLO");
